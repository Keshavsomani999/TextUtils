    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div className="d-flex">
          <div className="bg-primary rounded mx-2 border border-dark" onClick={()=>{props.toggleMode('primary')}} style={{height: '30px',width:'30px',cursor: 'pointer'}}></div>
          ...
          <div className="bg-dark rounded mx-2 border border-white" onClick={()=>{props.toggleMode('dark')}} style={{height: '30px',width:'30px',cursor: 'pointer'}}></div>
        ...
        {/* <img type="button" src={img} width="50" height="50" onClick={props.img} alt="hghv v g"/> */}
        {/* <button type="button" className="btn btn-primary" onClick={props.blue}></button> */}

        {/* <div className={`form-check form-switch text-${props.mode==='light'?'dark':'light'}`}>
        
        <input className="form-check-input" onClick={()=>{props.toggleMode(null)}} type="checkbox" role="switch" aria-checked="true" id="flexSwitchCheckDefault"/>
